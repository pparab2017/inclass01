...
abstract class Messages implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MessagesTableMap';
    ...
    /**
     * The value for the msgread field.
     *
    ...
    /**
     * The value for the msglock field.
     *
     * Note: this column has a database default value of: 'LOCK'
     * @var        string
     */
    protected $msglock;
    ...
    /**
     * Initializes internal state of Base\Messages object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [msglock] column value.
     *
     * @return string
     */
    public function getMsglock()
    {
        return $this->msglock;
    }
     ...
     * @return $this|\Messages The current object (for fluent API support)
     */
    ...
    public function setFromid($v)
    {
        ...
        if ($this->fromid !== $v) {
            $this->fromid = $v;
            $this->modifiedColumns[MessagesTableMap::COL_FROMID] = true;
        }
    ...
    public function setToid($v)
    {
        ...
        if ($this->toid !== $v) {
            $this->toid = $v;
            $this->modifiedColumns[MessagesTableMap::COL_TOID] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== null || $dt !== null) {
            if ($this->time === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->time->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MessagesTableMap::COL_TIME] = true;
            }
    ...
    public function setRegion($v)
    {
        ...
        if ($this->region !== $v) {
            $this->region = $v;
            $this->modifiedColumns[MessagesTableMap::COL_REGION] = true;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[MessagesTableMap::COL_CONTENT] = true;
        }
    ...
    /**
     * Set the value of [msgread] column.
     *
     * @param string $v new value
     * @return $this|\Messages The current object (for fluent API support)
     */
    public function setMsgread($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->msgread !== $v) {
            $this->msgread = $v;
            $this->modifiedColumns[MessagesTableMap::COL_MSGREAD] = true;
        }
    ...
    /**
     * Set the value of [msglock] column.
     *
     * @param string $v new value
     * @return $this|\Messages The current object (for fluent API support)
     */
    public function setMsglock($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->msglock !== $v) {
            $this->msglock = $v;
            $this->modifiedColumns[MessagesTableMap::COL_MSGLOCK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MessagesTableMap::translateFieldName('Fromid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fromid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MessagesTableMap::translateFieldName('Toid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->toid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MessagesTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MessagesTableMap::translateFieldName('Region', TableMap::TYPE_PHPNAME, $indexType)];
            $this->region = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MessagesTableMap::translateFieldName('Content', TableMap::TYPE_PHPNAME, $indexType)];
            $this->content = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : MessagesTableMap::translateFieldName('Msgread', TableMap::TYPE_PHPNAME, $indexType)];
            $this->msgread = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : MessagesTableMap::translateFieldName('Msglock', TableMap::TYPE_PHPNAME, $indexType)];
            $this->msglock = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = MessagesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Messages'), 0, $e);
        }
    }
    ...
    {
        if ($this->aUserRelatedByFromid !== null && $this->fromid !== $this->aUserRelatedByFromid->getId()) {
            $this->aUserRelatedByFromid = null;
        }
        if ($this->aUserRelatedByToid !== null && $this->toid !== $this->aUserRelatedByToid->getId()) {
            $this->aUserRelatedByToid = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MessagesTableMap::COL_FROMID)) {
            $modifiedColumns[':p' . $index++]  = 'fromID';
        }
        if ($this->isColumnModified(MessagesTableMap::COL_TOID)) {
            $modifiedColumns[':p' . $index++]  = 'toID';
        }
        if ($this->isColumnModified(MessagesTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(MessagesTableMap::COL_REGION)) {
            $modifiedColumns[':p' . $index++]  = 'region';
        }
        if ($this->isColumnModified(MessagesTableMap::COL_CONTENT)) {
            $modifiedColumns[':p' . $index++]  = 'Content';
        }
        if ($this->isColumnModified(MessagesTableMap::COL_MSGREAD)) {
            $modifiedColumns[':p' . $index++]  = 'msgRead';
        }
        if ($this->isColumnModified(MessagesTableMap::COL_MSGLOCK)) {
            $modifiedColumns[':p' . $index++]  = 'msgLock';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'fromID':
                        $stmt->bindValue($identifier, $this->fromid, PDO::PARAM_INT);
                        break;
                    case 'toID':
                        $stmt->bindValue($identifier, $this->toid, PDO::PARAM_INT);
                        break;
                    case 'time':
                    ...
                    case 'Content':
                        ...
                        break;
                    case 'msgRead':
                        $stmt->bindValue($identifier, $this->msgread, PDO::PARAM_STR);
                        break;
                    case 'msgLock':
                        $stmt->bindValue($identifier, $this->msglock, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                return $this->getMsgread();
                break;
            case 7:
                return $this->getMsglock();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aUserRelatedByFromid) {
                ...
                $result[$key] = $this->aUserRelatedByFromid->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aUserRelatedByToid) {
                ...
                $result[$key] = $this->aUserRelatedByToid->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                $this->setMsgread($value);
                break;
            case 7:
                $this->setMsglock($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setFromid($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setToid($arr[$keys[2]]);
        }
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setMsgread($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setMsglock($arr[$keys[7]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MessagesTableMap::COL_FROMID)) {
            $criteria->add(MessagesTableMap::COL_FROMID, $this->fromid);
        }
        if ($this->isColumnModified(MessagesTableMap::COL_TOID)) {
            $criteria->add(MessagesTableMap::COL_TOID, $this->toid);
        }
        if ($this->isColumnModified(MessagesTableMap::COL_TIME)) {
            $criteria->add(MessagesTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(MessagesTableMap::COL_REGION)) {
            $criteria->add(MessagesTableMap::COL_REGION, $this->region);
        }
        if ($this->isColumnModified(MessagesTableMap::COL_CONTENT)) {
            $criteria->add(MessagesTableMap::COL_CONTENT, $this->content);
        }
        if ($this->isColumnModified(MessagesTableMap::COL_MSGREAD)) {
            $criteria->add(MessagesTableMap::COL_MSGREAD, $this->msgread);
        }
        if ($this->isColumnModified(MessagesTableMap::COL_MSGLOCK)) {
            $criteria->add(MessagesTableMap::COL_MSGLOCK, $this->msglock);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMsgread($this->getMsgread());
        $copyObj->setMsglock($this->getMsglock());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     * @throws PropelException
     */
    public function setUserRelatedByFromid(ChildUser $v = null)
    {
        if ($v === null) {
            $this->setFromid(NULL);
        } else {
        ...
        if ($v !== null) {
            $v->addMessagesRelatedByFromid($this);
        }
    ...
    public function getUserRelatedByFromid(ConnectionInterface $con = null)
    {
        if ($this->aUserRelatedByFromid === null && ($this->fromid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserRelatedByFromid->addMessagessRelatedByFromid($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setUserRelatedByToid(ChildUser $v = null)
    {
        if ($v === null) {
            $this->setToid(NULL);
        } else {
        ...
        // If this object has already been added to the ChildUser object, it will not be re-added.
        if ($v !== null) {
            $v->addMessagesRelatedByToid($this);
        }
    ...
    public function getUserRelatedByToid(ConnectionInterface $con = null)
    {
        if ($this->aUserRelatedByToid === null && ($this->toid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByToid->addMessagessRelatedByToid($this);
             */
        }
    ...
    {
        if (null !== $this->aUserRelatedByFromid) {
            $this->aUserRelatedByFromid->removeMessagesRelatedByFromid($this);
        }
        if (null !== $this->aUserRelatedByToid) {
            $this->aUserRelatedByToid->removeMessagesRelatedByToid($this);
        }
        $this->id = null;
        $this->fromid = null;
        $this->toid = null;
