 ...
 */
abstract class Studyresponse implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\StudyresponseTableMap';
    ...
    /**
     * Initializes internal state of Base\Studyresponse object.
     */
    ...
    /**
     * Compares this with another <code>Studyresponse</code> instance.  If
     * <code>obj</code> is an instance of <code>Studyresponse</code>, delegates to
     * <code>equals(Studyresponse)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Studyresponse The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[StudyresponseTableMap::COL_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[StudyresponseTableMap::COL_USER_ID] = true;
        }
    ...
    public function setQuestionId($v)
    {
        ...
        if ($this->question_id !== $v) {
            $this->question_id = $v;
            $this->modifiedColumns[StudyresponseTableMap::COL_QUESTION_ID] = true;
        }
    ...
    public function setResponse($v)
    {
        ...
        if ($this->response !== $v) {
            $this->response = $v;
            $this->modifiedColumns[StudyresponseTableMap::COL_RESPONSE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StudyresponseTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StudyresponseTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StudyresponseTableMap::translateFieldName('QuestionId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStudyresponseQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Studyresponse::setDeleted()
     * @see Studyresponse::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStudyresponseQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StudyresponseTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StudyresponseTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(StudyresponseTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'User_id';
        }
        if ($this->isColumnModified(StudyresponseTableMap::COL_QUESTION_ID)) {
    ...
    {
        $pos = StudyresponseTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Studyresponse'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Studyresponse'][$this->hashCode()] = true;
        $keys = StudyresponseTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StudyresponseTableMap::COL_ID)) {
            $criteria->add(StudyresponseTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(StudyresponseTableMap::COL_USER_ID)) {
            $criteria->add(StudyresponseTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(StudyresponseTableMap::COL_QUESTION_ID)) {
            $criteria->add(StudyresponseTableMap::COL_QUESTION_ID, $this->question_id);
        }
        if ($this->isColumnModified(StudyresponseTableMap::COL_RESPONSE)) {
    ...
    {
        $criteria = ChildStudyresponseQuery::create();
        $criteria->add(StudyresponseTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Studyresponse (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Studyresponse Clone of current object.
     * @throws PropelException
     */
    ...
    public function getQuestions(ConnectionInterface $con = null)
    {
        if ($this->aQuestions === null && ($this->question_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aQuestions->addStudyresponses($this);
             */
        }
    ...
    public function getNewuser(ConnectionInterface $con = null)
    {
        if ($this->aNewuser === null && ($this->user_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aNewuser->addStudyresponses($this);
             */
        }
    ...
    {
        if (null !== $this->aQuestions) {
            $this->aQuestions->removeStudyresponse($this);
        }
        if (null !== $this->aNewuser) {
            $this->aNewuser->removeStudyresponse($this);
        }
        $this->id = null;
        $this->user_id = null;
    ...
    {
        return (string) $this->exportTo(StudyresponseTableMap::DEFAULT_STRING_FORMAT);
    }
