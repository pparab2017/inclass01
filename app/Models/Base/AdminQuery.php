...
abstract class AdminQuery extends ModelCriteria
{
    ...
    {
        return $this->addUsingAlias(AdminTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(AdminTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(AdminTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(AdminTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(AdminTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(AdminTableMap::COL_CREATED_AT);
    }
