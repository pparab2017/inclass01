...
abstract class ProjectMessagesQuery extends ModelCriteria
{
    ...
    {
        return $this->addUsingAlias(ProjectMessagesTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ProjectMessagesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(ProjectMessagesTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ProjectMessagesTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(ProjectMessagesTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(ProjectMessagesTableMap::COL_CREATED_AT);
    }
