...
class NewuserTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'Hash', 'Fname', 'Lname', 'Gender', 'Role', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'email', 'hash', 'fname', 'lname', 'gender', 'role', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(NewuserTableMap::COL_ID, NewuserTableMap::COL_EMAIL, NewuserTableMap::COL_HASH, NewuserTableMap::COL_FNAME, NewuserTableMap::COL_LNAME, NewuserTableMap::COL_GENDER, NewuserTableMap::COL_ROLE, NewuserTableMap::COL_CREATED_AT, NewuserTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'email', 'hash', 'fname', 'lname', 'gender', 'role', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Email' => 1, 'Hash' => 2, 'Fname' => 3, 'Lname' => 4, 'Gender' => 5, 'Role' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'email' => 1, 'hash' => 2, 'fname' => 3, 'lname' => 4, 'gender' => 5, 'role' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        self::TYPE_COLNAME       => array(NewuserTableMap::COL_ID => 0, NewuserTableMap::COL_EMAIL => 1, NewuserTableMap::COL_HASH => 2, NewuserTableMap::COL_FNAME => 3, NewuserTableMap::COL_LNAME => 4, NewuserTableMap::COL_GENDER => 5, NewuserTableMap::COL_ROLE => 6, NewuserTableMap::COL_CREATED_AT => 7, NewuserTableMap::COL_UPDATED_AT => 8, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'email' => 1, 'hash' => 2, 'fname' => 3, 'lname' => 4, 'gender' => 5, 'role' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
