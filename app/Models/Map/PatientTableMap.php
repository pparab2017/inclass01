...
class PatientTableMap extends TableMap
{
     ...
     */
    const COL_USER_ID = 'Patient.user_id';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PatientTableMap::COL_ID, PatientTableMap::COL_USER_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PatientTableMap::COL_ID => 0, PatientTableMap::COL_USER_ID => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('user_id', 'UserId', 'INTEGER', 'NewUser', 'id', true, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PatientTableMap::COL_USER_ID);
        } else {
