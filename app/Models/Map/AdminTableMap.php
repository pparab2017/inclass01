...
class AdminTableMap extends TableMap
{
     ...
     */
    const COL_FNAME = 'Admin.fname';

    /**
     * the column name for the lname field
     */
    const COL_LNAME = 'Admin.lname';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'Admin.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'Admin.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'Hash', 'Fname', 'Lname', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'email', 'hash', 'fname', 'lname', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID, AdminTableMap::COL_EMAIL, AdminTableMap::COL_HASH, AdminTableMap::COL_FNAME, AdminTableMap::COL_LNAME, AdminTableMap::COL_CREATED_AT, AdminTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'email', 'hash', 'fname', 'lname', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Email' => 1, 'Hash' => 2, 'Fname' => 3, 'Lname' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'email' => 1, 'hash' => 2, 'fname' => 3, 'lname' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID => 0, AdminTableMap::COL_EMAIL => 1, AdminTableMap::COL_HASH => 2, AdminTableMap::COL_FNAME => 3, AdminTableMap::COL_LNAME => 4, AdminTableMap::COL_CREATED_AT => 5, AdminTableMap::COL_UPDATED_AT => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'email' => 1, 'hash' => 2, 'fname' => 3, 'lname' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AdminTableMap::COL_FNAME);
            $criteria->addSelectColumn(AdminTableMap::COL_LNAME);
